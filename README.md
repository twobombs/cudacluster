...
The container node sees the underlying hardware PCI bus times the amount of nodes on the host so the controller node will see an X-amount of CUDA cores.
