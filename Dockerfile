...
RUN apt-get update&&apt-get install -y git software-properties-common ant openjdk-8-jdk qv4l2 python-software-properties python-setuptools python3-setuptools python-migrate && apt-get clean all
