...
RUN apt-get update&&apt-get install -y git software-properties-common ant openjdk-8-jdk qv4l2 software-properties-common python-setuptools python3-setuptools python-migrate && apt-get clean all
